    ...
    return (
        <div className='commitImg-container'>
            ...
            <Row gutter={{ xs: 8, sm: 16, md: 24, lg: 32 }} >
                <Col className="gutter-row py-3" xs={{ span: 12 }} md={{ span: 8 }} lg={{ span: 6 }} data-aos="zoom-in-right"  data-aos-duration="2000">
                ...
                <Col className="gutter-row py-3" xs={{ span: 12 }} md={{ span: 8 }} lg={{ span: 6 }} data-aos="zoom-out"  data-aos-duration="2000">
                    <div className='d-flex flex-column'>
                ...
                <Col className="gutter-row py-3" xs={{ span: 12 }} md={{ span: 8 }} lg={{ span: 6 }} data-aos="zoom-in-left"  data-aos-duration="2000">
                    <div className='d-flex flex-column'>
